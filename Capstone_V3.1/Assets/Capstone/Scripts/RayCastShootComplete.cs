...
public class RayCastShootComplete : MonoBehaviour
{
    ...
    public float fireRate = 0.15f;                                      // Number in seconds which controls how often the player can fire
    ...
    public ShootableBox sb;
    public MovePlatform mp;
    public MoveablePlatform mc;
    public MultiMove mm;
    public bool froze;
    ...
    void Start()
    {
        ...
        //LineRenderer laserline = gameObject.AddComponent<LineRenderer>();
